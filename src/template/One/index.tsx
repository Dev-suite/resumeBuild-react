                ...
                {itemStatus.info && (
                    <div className={[styles.info, styles.box].join(' ')}>
                        <Text
                            ...
                            tag="div"
                        />
                        <Text value={this.props.userData.address} statename="userData.address" placeholder="address: Ilorin, Nigeria" />
                        <Text value={this.props.userData.email} statename="userData.email" placeholder="info@resumebuid.com" />
                        <Text value={this.props.userData.mobile} statename="userData.mobile" placeholder="234 821 000 00 00" />
